...
export default function AssetInventoryEditeForm() {
  ...
  const form = useForm<z.infer<typeof assetInventorySchema>>({
    ...
    defaultValues: {
      asset_Name: "طاولة مكتب ثنائي",
      asset_Number_class: "6",
      asset_Number_subclass: "1",
      asset_Number_detail: "2",
      asset_Number_id: "1136",
      asset_State: "جيد",
      asset_Place: "ادارة تقنية",
      asset_Reciever: "محمد مصباح",
      board_Number: null,
      motor_Number: null,
